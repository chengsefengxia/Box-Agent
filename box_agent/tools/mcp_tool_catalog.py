    ...
    def _ranked_search(
        ...
        *,
        ...
        for (
            ...
            exact_priority = 3
            if normalized_query in {normalized_name, normalized_remote_name}:
                exact_priority = 0
                ...
                len(normalized_name) >= 3 and normalized_name in normalized_query
            ) or (
                len(normalized_remote_name) >= 3
                and normalized_remote_name in normalized_query
            ):
